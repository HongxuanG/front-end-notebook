        ...
        this.then = function (onFulfilled1, onRejected1) {
            ...
            var promise2 = new MyPromise(function (resolve, reject) {
                if (_this.PromiseState === State.FULFILLED) {
                    ...
                    setTimeout(function () {
                        try {
                            ...
                            var x = onFulfilled1 === null || onFulfilled1 === void 0 ? void 0 : onFulfilled1(_this.PromiseResult);
                ...
                if (_this.PromiseState === State.REJECTED) {
                    setTimeout(function () {
                        try {
                            var x = onRejected1 === null || onRejected1 === void 0 ? void 0 : onRejected1(_this.PromiseResult);
                            resolvePromise(promise2, x, resolve, reject);
                        }
                        catch (e) {
...
// @ts-ignore
Reflect.set(MyPromise, 'deferred', function () {
    var result = {};
    Reflect.set(result, 'promise', new MyPromise(function (resolve, reject) {
